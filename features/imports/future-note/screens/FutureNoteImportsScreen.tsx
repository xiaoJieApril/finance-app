...
import { CurrencyCode, FutureNoteImport, TransactionEntry } from '@/features/finance/types';
import { formatMoney } from '@/features/finance/utils/finance';

/**
 * Future Note inbox route.
 *
 * Lets the user review staged external expenses before creating ledger entries.
 */
