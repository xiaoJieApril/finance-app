/**
 * Finance repository for Supabase-backed domain data.
 *
 * This module owns the v2 finance tables, legacy compatibility mapping, and
 * mutations for accounts, categories, transaction entries, budgets, goals, and
 * recurring items. UI code should go through hooks instead of calling Supabase
 * directly.
 */
import {
  AccountType,
