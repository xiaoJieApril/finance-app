/**
 * Local reminder and budget-alert scheduling.
 *
 * This keeps Expo local notifications for reminders only. Android
 * notification-reading import support was removed from the product.
 */
import AsyncStorage from '@react-native-async-storage/async-storage';
import * as Notifications from 'expo-notifications';
import { Platform } from 'react-native';
import { Category, RecurringItem, Transaction } from '@/features/finance/types';
